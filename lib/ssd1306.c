...
void anima(ssd1306_t *ssd)
{
  ...
  for (int j = 0; j < 64; j++)
  {
    ...
    {
      int a = j * 128 + i;
      if (new_piskel_data[a] > 0x00010000)
      {
...
// Funçao que desenha o semaforo no display ssd1306
void barras(ssd1306_t *ssd)
{
  // Linhas horizontais
  ssd1306_line(ssd, 12, 13, 114, 13, true);
  ssd1306_line(ssd, 12, 21, 114, 21, true);
  ssd1306_line(ssd, 12, 42, 114, 42, true);
  ssd1306_line(ssd, 12, 50, 114, 50, true);
  // Linhas vertical
  ssd1306_line(ssd, 11, 14, 11, 20, true);
  ssd1306_line(ssd, 115, 14, 115, 20, true);
  ssd1306_line(ssd, 115, 43, 115, 49, true);
  ssd1306_line(ssd, 11, 43, 11, 49, true);
  // Pixels
  ssd1306_pixel(ssd, 12, 14, true);
  ssd1306_pixel(ssd, 114, 14, true);
  ssd1306_pixel(ssd, 114, 20, true);
  ssd1306_pixel(ssd, 12, 20, true);
  ssd1306_pixel(ssd, 12, 43, true);
  ssd1306_pixel(ssd, 12, 49, true);
  ssd1306_pixel(ssd, 114, 49, true);
  ssd1306_pixel(ssd, 114, 43, true);
}
